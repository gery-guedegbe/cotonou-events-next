    ...
    <aside className="flex flex-col gap-4 lg:sticky lg:top-[88px]">
      <div className="rounded-2xl border border-gray-200 bg-white p-5 shadow-card">
        ...
        <a
          ...
          className="flex h-[46px] items-center justify-center gap-2.5 rounded-pill bg-whatsapp text-[14.5px] font-semibold text-white"
        >
        ...
        <button
          onClick={copy}
          className="mt-2.5 flex h-[46px] w-full items-center justify-center gap-2.5 rounded-pill border-[1.5px] border-gray-200 bg-white text-[14.5px] font-semibold text-gray-700 transition-colors hover:border-brand hover:text-brand"
        >
          {copied ? (
      ...
      <div className="rounded-2xl border border-brand-light bg-[#F0FDF4] p-5">
        ...
        <p className="mb-3.5 mt-1.5 text-[13px] text-gray-500">
          Recevez les meilleurs plans chaque vendredi sur WhatsApp.
        </p>

        <SubscribeForm buttonLabel="S'abonner aux alertes" />
      </div>
    </aside>
  );
}
