...
export function LegalPage({ slug }: { slug: LegalSlug }) {
  ...
  return (
    <div className="mx-auto max-w-[720px] px-5 pb-20 pt-12">
      <Link
        href="/"
      ...
      <div className="mt-10 flex flex-wrap items-center gap-3.5 rounded-2xl border border-brand-light bg-[#F0FDF4] p-6">
        ...
        <Link
          href="/alertes"
          className="rounded-pill bg-brand px-5 py-2.5 text-sm font-semibold text-white"
        >
