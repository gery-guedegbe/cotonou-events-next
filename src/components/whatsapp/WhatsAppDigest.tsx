...
const LINES: DigestLine[] = [
  { emoji: "🎵", title: "Afro Nuit Live", meta: "Sam 17 mai · 20h · Haie-Vive · 5 000 F" },
  { emoji: "🎨", title: "Marché des Créateurs", meta: "Dim 18 mai · 10h · Centre-ville · Gratuit" },
  { emoji: "⚽", title: "Tournoi de football U17", meta: "Sam 17 mai · 15h · Akpakpa · Gratuit" },
];
...
function ChatHeader({ compact }: { compact?: boolean }) {
  return (
    <div className="flex items-center gap-3 bg-whatsapp-header px-4 py-3">
      ...
      <div>
        <div className={compact ? "text-sm font-bold text-white" : "text-[15px] font-bold text-white"}>
          Cotonou.events
        </div>
 ...
 */
export function WhatsAppDigest({ variant = "full" }: { variant?: "full" | "mini" }) {
    ...
    <div className="overflow-hidden">
      ...
      <div className="bg-whatsapp-bg px-3.5 pb-5 pt-4">
        <div className="rounded-[12px_12px_0_12px] bg-whatsapp-bubble p-3.5 shadow-[0_1px_1px_rgba(0,0,0,0.08)]">
          <div className="text-sm font-bold text-whatsapp-header">📅 Vos événements du week-end</div>
          ...
          <div className="mt-2 text-[11.5px] text-[#667781]">Pour vous désabonner, répondez STOP.</div>
          <div className="mt-1.5 flex items-center justify-end gap-1">
            <span className="text-[11px] text-[#667781]">Ven. 18:00</span>
            <CheckCheck className="h-[15px] w-[15px] text-[#34B7F1]" aria-hidden />
          </div>
        </div>
      </div>
    </div>
